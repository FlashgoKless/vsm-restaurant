...
### Модель данных
Примечание: Не стоит воспринимать написанное ниже как истину в последней инстанции. Ниже - результат коллективного творчества, который не верифицировался на практике.
